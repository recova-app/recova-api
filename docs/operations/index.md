---
title: Recova Backend Operations Index
description: Indeks dokumentasi operasional untuk menjalankan, memantau, mengamankan, merilis, dan memulihkan layanan Recova Backend.
owner: backend-owner
reviewers:
  - engineering-lead
...
Halaman ini memetakan dokumen operasi harian layanan, termasuk security baseline, observability, testing, CI/CD, container runtime, dan health checks.

## Operations Documentation Scope

- runbook operasional,
- security dan incident readiness,
- observability, logging, metrics, dan tracing,
- testing dan release gates,
- container dan local runtime strategy.
...
- [Post-Migration Maintenance](/Users/macbookpro/Development/recova-backend-v2/docs/operations/post-migration-maintenance.md)
