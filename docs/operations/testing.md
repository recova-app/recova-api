...
8. `make module-consistency-full-check` lulus untuk cleanup behavior-preserving lintas module.

Tambahan gate:

9. semua perubahan file/config dalam scope rilis memiliki test companion atau exception rationale terdokumentasi.
10. report release confidence E2E + performance tersedia dan dapat diaudit.
