---
title: Recova Backend Modules Index
description: Indeks dokumentasi modul domain dan tanggung jawab setiap capability utama layanan Recova Backend.
owner: backend-owner
reviewers:
  - engineering-lead
...
Halaman ini menjadi entry point dokumentasi per modul domain agar boundary fungsi setiap capability jelas dan mudah ditelusuri.

## Module Documentation Scope

- domain responsibility tiap modul,
